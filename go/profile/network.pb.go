...
type NetworkInfo struct {
	...
	LocalChanges []*NetworkPortConfig `protobuf:"bytes,5,rep,name=local_changes,json=localChanges,proto3" json:"local_changes,omitempty"`
}
...
func (x *NetworkInfo) GetLocalChanges() []*NetworkPortConfig {
	if x != nil {
...
type NetworkConfigChange struct {
	...
	UpdatedPorts []*NetworkPortConfig `protobuf:"bytes,2,rep,name=updated_ports,json=updatedPorts,proto3" json:"updated_ports,omitempty"`
	// Ports for which locally applied configuration should be removed,
	// reverting to the controller-provided configuration.
	// Identified by port logical labels.
	RevertedPorts []string `protobuf:"bytes,3,rep,name=reverted_ports,json=revertedPorts,proto3" json:"reverted_ports,omitempty"`
}
...
func (x *NetworkConfigChange) GetUpdatedPorts() []*NetworkPortConfig {
	if x != nil {
		return x.UpdatedPorts
	}
	return nil
}

func (x *NetworkConfigChange) GetRevertedPorts() []string {
	if x != nil {
		return x.RevertedPorts
	}
	return nil
}
...
type NetworkPortConfig struct {
	...
	// When included in `NetworkConfigChange.updated_ports` received from LPS,
	...
	// Inside `NetworkConfigChange.updated_ports`, received by EVE from LPS,
	...
	// This may indicate a problem with the configuration itself (invalid values
	// or disallowed changes) or with the port's current state (e.g., missing IP
	// or DNS on the management port, link down, or other connectivity issues).
	// This field is empty if the last applied configuration for this port was
	// accepted and fully operational.
	// Even if an error is reported, the configuration might still be (at least
	// partially) applied; use the `config_applied` field to determine whether
	// the port is currently using the requested configuration despite any issues.
	// Inside `NetworkConfigChange.updated_ports`, received by EVE from LPS,
	// this field is ignored.
...
var file_profile_network_proto_rawDesc = []byte{
	...
	0x6d, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x03, 0x0a, 0x0b, 0x4e, 0x65, 0x74,
	0x77, 0x6f, 0x72, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x4e, 0x0a, 0x0d, 0x6c, 0x61, 0x74, 0x65,
	0x73, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	,
	...
	,
	...
	0x66, 0x69, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x4c, 0x0a, 0x0d, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	0x70, 0x65, 0x12, 0x4b, 0x0a, 0x0e, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0x5f, 0x69, 0x70, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x6f, 0x72, 0x67,
	...
	,
	...
	,
	...
	0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1a, 0x0a, 0x16, 0x57, 0x49, 0x52, 0x45, 0x4c, 0x45, 0x53,
	0x53, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x43, 0x45, 0x4c, 0x4c, 0x55, 0x4c, 0x41, 0x52, 0x10,
	0x01, 0x12, 0x16, 0x0a, 0x12, 0x57, 0x49, 0x52, 0x45, 0x4c, 0x45, 0x53, 0x53, 0x5f, 0x54, 0x59,
	0x50, 0x45, 0x5f, 0x57, 0x49, 0x46, 0x49, 0x10, 0x02, 0x42, 0x3f, 0x0a, 0x16, 0x6f, 0x72, 0x67,
	0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x66,
...
var file_profile_network_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_profile_network_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_profile_network_proto_goTypes = []interface{}{
	(IPVersion)(0),                      // 0: org.lfedge.eve.profile.IPVersion
	(WirelessType)(0),                   // 1: org.lfedge.eve.profile.WirelessType
	(*NetworkInfo)(nil),                 // 2: org.lfedge.eve.profile.NetworkInfo
	(*NetworkConfigTestingStatus)(nil),  // 3: org.lfedge.eve.profile.NetworkConfigTestingStatus
	(*NetworkConfigChange)(nil),         // 4: org.lfedge.eve.profile.NetworkConfigChange
	(*NetworkPortAddresses)(nil),        // 5: org.lfedge.eve.profile.NetworkPortAddresses
	(*NetworkPortConfig)(nil),           // 6: org.lfedge.eve.profile.NetworkPortConfig
	(*CellularConfig)(nil),              // 7: org.lfedge.eve.profile.CellularConfig
	(*CellularNetworkAuth)(nil),         // 8: org.lfedge.eve.profile.CellularNetworkAuth
	(*WifiConfig)(nil),                  // 9: org.lfedge.eve.profile.WifiConfig
	(*timestamppb.Timestamp)(nil),       // 10: google.protobuf.Timestamp
	(*evecommon.DhcpOptionsIgnore)(nil), // 11: org.lfedge.eve.common.DhcpOptionsIgnore
	(*evecommon.ProxyConfig)(nil),       // 12: org.lfedge.eve.common.ProxyConfig
	(*evecommon.PortConfigSource)(nil),  // 13: org.lfedge.eve.common.PortConfigSource
	(evecommon.CellularIPType)(0),       // 14: org.lfedge.eve.common.CellularIPType
	(evecommon.CellularAuthProtocol)(0), // 15: org.lfedge.eve.common.CellularAuthProtocol
	(evecommon.WiFiKeyScheme)(0),        // 16: org.lfedge.eve.common.WiFiKeyScheme
}
var file_profile_network_proto_depIdxs = []int32{
	6,  // 0: org.lfedge.eve.profile.NetworkInfo.latest_config:type_name -> org.lfedge.eve.profile.NetworkPortConfig
	3,  // 1: org.lfedge.eve.profile.NetworkInfo.config_testing:type_name -> org.lfedge.eve.profile.NetworkConfigTestingStatus
	6,  // 2: org.lfedge.eve.profile.NetworkInfo.fallback_config:type_name -> org.lfedge.eve.profile.NetworkPortConfig
	6,  // 3: org.lfedge.eve.profile.NetworkInfo.local_changes:type_name -> org.lfedge.eve.profile.NetworkPortConfig
	10, // 4: org.lfedge.eve.profile.NetworkConfigTestingStatus.last_test_time:type_name -> google.protobuf.Timestamp
	6,  // 5: org.lfedge.eve.profile.NetworkConfigChange.updated_ports:type_name -> org.lfedge.eve.profile.NetworkPortConfig
	5,  // 6: org.lfedge.eve.profile.NetworkPortConfig.port_addresses:type_name -> org.lfedge.eve.profile.NetworkPortAddresses
	0,  // 7: org.lfedge.eve.profile.NetworkPortConfig.ip_version:type_name -> org.lfedge.eve.profile.IPVersion
	11, // 8: org.lfedge.eve.profile.NetworkPortConfig.dhcp_options_ignore:type_name -> org.lfedge.eve.common.DhcpOptionsIgnore
	12, // 9: org.lfedge.eve.profile.NetworkPortConfig.proxy_config:type_name -> org.lfedge.eve.common.ProxyConfig
	1,  // 10: org.lfedge.eve.profile.NetworkPortConfig.wireless_device_type:type_name -> org.lfedge.eve.profile.WirelessType
	7,  // 11: org.lfedge.eve.profile.NetworkPortConfig.cellular_config:type_name -> org.lfedge.eve.profile.CellularConfig
	9,  // 12: org.lfedge.eve.profile.NetworkPortConfig.wifi_config:type_name -> org.lfedge.eve.profile.WifiConfig
	13, // 13: org.lfedge.eve.profile.NetworkPortConfig.config_source:type_name -> org.lfedge.eve.common.PortConfigSource
	14, // 14: org.lfedge.eve.profile.CellularConfig.ip_type:type_name -> org.lfedge.eve.common.CellularIPType
	14, // 15: org.lfedge.eve.profile.CellularConfig.attach_ip_type:type_name -> org.lfedge.eve.common.CellularIPType
	8,  // 16: org.lfedge.eve.profile.CellularConfig.default_bearer_auth:type_name -> org.lfedge.eve.profile.CellularNetworkAuth
	8,  // 17: org.lfedge.eve.profile.CellularConfig.attach_bearer_auth:type_name -> org.lfedge.eve.profile.CellularNetworkAuth
	15, // 18: org.lfedge.eve.profile.CellularNetworkAuth.auth_protocol:type_name -> org.lfedge.eve.common.CellularAuthProtocol
	16, // 19: org.lfedge.eve.profile.WifiConfig.key_scheme:type_name -> org.lfedge.eve.common.WiFiKeyScheme
...
func file_profile_network_proto_init() {
	...
	file_profile_network_proto_msgTypes[4].OneofWrappers = []interface{}{
