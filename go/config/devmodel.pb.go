...
type SystemAdapter struct {
	...
	// Shared label can be used to designate a group of network adapters to be used by
	// a network instances for external connectivity, or to limit port-forwarding firewall
	// rule to only a subset of network adapters.
