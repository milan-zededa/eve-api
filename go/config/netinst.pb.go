...
type IPRoute struct {
	...
	// This can be an external gateway IP or an IP address of one of the apps connected
	...
	// to routes where gateway points to another application running on EVE.
...
type NetworkInstanceConfig struct {
	...
	// label in SystemAdapter.SharedLabels).
